            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <a  href="" title="System Setup">
                                   <span class="educate-icon educate-event icon-wrap sub-icon-mg"></span>
                                   <span class="mini-click-non">System Setup</span>
                            </a>
                        </li>

                        <li>
                            <a  href="" title="Class Setup">
                                   <span class="educate-icon educate-course icon-wrap"></span>
                                   <span class="mini-click-non">Class Setup</span>
                            </a>
                        </li>  

                        <li>
                            <a  href="" title="Academic Year">
                                   <span class="educate-icon educate-event icon-wrap sub-icon-mg"></span>
                                   <span class="mini-click-non">Academic Year</span>
                            </a>
                        </li>                      

                        <li>
                            <a class="has-arrow" href="all-professors.html" aria-expanded="false"><span class="educate-icon educate-event icon-wrap sub-icon-mg"></span> <span class="mini-click-non">School Confiig</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a href="{{route('addnewschool')}}" title="Add New School" href="all-professors.html"><span class="mini-sub-pro">Add New School</span></a></li>
                            </ul>
                        </li>
