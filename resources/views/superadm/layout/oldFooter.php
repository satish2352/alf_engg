<div class="footer-copyright-area">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p>Copyright © 2018. All rights reserved<a href=""></a></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- tab JS
        ============================================ -->
    <script src="{{asset('asset/js/tab.js')}}"></script>
    <!-- icheck JS
        ============================================ -->
    ...
    <script src="{{asset('asset/js/metisMenu/metisMenu-active.js')}}"></script>
     ...
     <!--  editable JS
        ============================================ -->
    <script src="{{asset('asset/js/editable/jquery.mockjax.js')}}"></script>
    <script src="{{asset('asset/js/editable/mock-active.js')}}"></script>
    <script src="{{asset('asset/js/editable/select2.js')}}"></script>
    <script src="{{asset('asset/js/editable/moment.min.js')}}"></script>
    <script src="{{asset('asset/js/editable/bootstrap-datetimepicker.js')}}"></script>
    <script src="{{asset('asset/js/editable/bootstrap-editable.js')}}"></script>
    <script src="{{asset('asset/js/editable/xediable-active.js')}}"></script>
    <!-- Chart JS
        ============================================ -->
    <script src="{{asset('asset/js/chart/jquery.peity.min.js')}}"></script>
