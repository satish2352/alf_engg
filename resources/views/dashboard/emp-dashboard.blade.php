                    ...
                    <div class="row">
                        ...
                        @foreach ($projects as $index => $project)
                            ...
                            <div class="col-lg-4 col-md-6 mb-4">
                                ...
                                {{-- <a href="{{ $project->project_url }}?plant_no={{$project->plant_id}}&emp_code={{ session('emp_code') }}&fy_id={{ session('emp_financial_year_id') }}">  target="_blank" --}}
                                <a href="{{ $project->project_url }}?plant_code={{ session('emp_plant_code') }}&emp_code={{ $project->emp_code }}&fy={{ $project->financial_year }}&role={{ session('emp_role_name') }}&com_portal_url={{ session('com_portal_url') }}">
